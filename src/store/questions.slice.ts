...
export const QuestionPageSlice = createSlice({
  ...
  reducers: {
    ...
    setQuestionTableDeleteData: (state: QuestionPageSliceState, action: PayloadAction<{ questionId: string | undefined, isDeleting: boolean, showDeleteDialog: boolean }>) => {
    ...
    setQuestionFormSubtopics: (state: QuestionPageSliceState, action: PayloadAction<{ operation_type: array_operation, value: string }>) => {
